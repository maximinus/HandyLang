...
class TestNumberTokens(unittest.TestCase):
    def test_integer(self):
        ...
        self.assertEqual(tokenize("42"), [("NUMBER", "42")])
    
    def test_decimal(self):
        """Test decimal number token recognition"""
        self.assertEqual(tokenize("3.14"), [("NUMBER", "3.14")])
    
    def test_zero(self):
        """Test zero token recognition"""
        self.assertEqual(tokenize("0"), [("NUMBER", "0")])
    
    def test_decimal_zero(self):
        """Test decimal zero token recognition"""
        self.assertEqual(tokenize("1.0"), [("NUMBER", "1.0")])
